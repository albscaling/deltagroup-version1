...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Delta Group — linjë e plotë prodhimi mobiljesh dhe rishitësi ekskluziv në Shqipëri. Cilësi italiane, dizajn modern." },
      { name: "author", content: "Delta Group" },
      { property: "og:title", content: "Delta Group — Premium Furniture in Albania" },
      { property: "og:description", content: "Exclusive Albanian reseller and full furniture production line." },
